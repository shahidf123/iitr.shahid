...
function preload() {
  // Load your images
  image1 = loadImage('FatR.png');
  image2 = loadImage('BlankR.png');
  // img = loadImage('Cap.png');
  bgImg = loadImage('bg3.png');
  image3 = loadImage('droper.png');
  frontflask = loadImage('frontflask2.png');
  frontflask2 = loadImage('frontflask1.png');
  liquid = loadImage('Halfwater2.png');
  nextimg = loadImage('Forward.png');
  // arow = loadImage('Arrow.png');
...
function draw() {console.log("MouseX: " + mouseX + ", MouseY: " + mouseY);
  ...
  image(liquid, 390, 453, 135, 30);
  image(liquid, 245, 453, 135, 30);
  // image(arow, 242, 232, 500, 100);
  pop();
  
  //To show KMnO4 container
  image(image1, 480, 220, 200, 200);
  image(image2, 600, 220, 200, 200);

  image(frontflask, 400, 320, 120, 160);
  image(frontflask2, 250, 320, 120, 160);
