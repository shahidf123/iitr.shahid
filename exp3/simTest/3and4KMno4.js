...
function preload() {
  // Load your images
  image1 = loadImage('Fatjar.png');
  imageKOH = loadImage('KOHjar.png');
  img = loadImage('Cap.png');

  bgImg = loadImage('bg3.png');
  image3 = loadImage('droper.png');
  frontflask = loadImage('RBFat.png');
  frontflask2 = loadImage('RBBlank.png');
  waterbath1 = loadImage('waterbath.png');
...
function draw() {
  ...
  image(liquid, 414, 410, 80, 57);
  image(liquid, 302, 390, 80, 57);
  pop();
  image(frontflask, 340, 240, 250, 260);
  image(frontflask2, 228, 220, 250, 260);
  image(waterbath1, 10, 220, 246, 260);
  //console.log("MouseX: " + mouseX + ", MouseY: " + mouseY);

   //To show KMnO4 container
   image(image1, 505, 251, 200, 200);
   image(imageKOH, 600, 251, 200, 200);
  ...
  if (millis() % (2 * blinkInterval) < blinkInterval) {
    ...
    imagee(nextimg, nxtx, nxty, nxtw, nxth);
  }
