...
function setup() {
  ...
  changetint = color(125, 49, 13);//Defining the net at starting
  aftercolour = color(239, 227, 133);//Defining the net colour after titration
...
function start() {
  ...
  normality_titrant = random(0.6, .9);
