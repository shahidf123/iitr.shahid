...
function setup() {
  ...
  changetint = color(255, 255, 255 );//Defining the net at starting
  aftercolour = color(252, 89, 196, 200);//Defining the net colour after titration
...
function start() {
  ...
  normality_titrant = random(1.1, 2.0);
